...
export const EditExerciseComponent = ({ navigation, route, isAddExerciseScreen }: any) => {
    const exerciseProp = route?.params?.exercise;
    ...
    const [parameters, setParameters] = useState(() => {
        ...
        if (Array.isArray(exerciseProp?.requiredParameters)) {
            exerciseProp.requiredParameters.forEach((param: any) => {
    ...
    return (
        <View style={styles.container}>
            <View style={{
                ...
                >{isAddExerciseScreen ? 'Add Exercise' : 'Edit Exercise'}</Text>
            </View>
            ...
            <View style={{
                ...
                >
                    <Text style={{
                        ...
                        fontSize: normalize(16),
                        fontWeight: '500'
                    }}>{isAddExerciseScreen ? 'Add' : 'Update'}</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
